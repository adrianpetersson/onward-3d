...
export function App() {
  ...
  return (
    <div className="relative size-full overflow-hidden">
      ...
      {/*
       * Keyed on `generation` so a Trip that arrives from the FILE — adopted on load, or chosen after
       * a conflict — reaches the sidebar's draft. The draft lives in a reducer seeded from this prop,
       * which is exactly the state a re-render cannot reseed.
       */}
      <Sidebar
